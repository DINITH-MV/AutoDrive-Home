...
<link rel="stylesheet" href="./css/accidentRepair.css" />
<link rel="stylesheet"
...
<body>
	...
	<div class="backBox">
		<div class="diagonal-split3">
			<div class="banner">Accident<br> Repair service</div>
		</div>
	</div>
	<div class="SecondSession"></div>
	<form action="AccidentRepairAppointmentServlet" method="post">
		<div class="container">
			...
			<div class="row">
				<label for="date_time">Date and time:</label> <input
					type="datetime-local" id="date_time" name="dateTime" />
			</div>
