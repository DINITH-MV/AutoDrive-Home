...
pageEncoding="UTF-8"%> <%@page import="java.sql.*"%><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    DriverManager.getConnection("jdbc:mysql://localhost:3306/tourguide", "root",
    "root"); String id = request.getParameter("id"); int lmID =
    Integer.parseInt(id); String sql = "select * from autodrive.learnmore where
    lmID=" + lmID + ""; stmt = conn.createStatement(); rs =
